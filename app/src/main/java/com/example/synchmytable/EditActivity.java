...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkMode(){
        Intent i = getIntent();
        mode = i.getIntExtra("mode",StudentHomePage.REQUEST_ADD);

        if(mode == StudentHomePage.REQUEST_EDIT){
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submit_btn:
                if(mode == StudentHomePage.REQUEST_ADD){
                    inputDataProcessing();
                    Intent i = new Intent();
                ...
                else if(mode == StudentHomePage.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
